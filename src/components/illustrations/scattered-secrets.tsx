...
// Each piece drifts on its own slow infinite loop (`ss-drift*` in globals.css);
// the outer <g> carries the CSS motion, the inner <g> keeps its static rotation.
export function ScatteredSecretsIllustration() {
  return (
    ...
    >
      ...
      >
        {/* chat bubble, tilted */}
        <g className="ss-drift ss-drift--1">
        ...
        <g className="ss-drift ss-drift--2">
        ...
        {/* envelope, tilted */}
        <g className="ss-drift ss-drift--3">
        ...
        <g className="ss-drift ss-drift--4">
        ...
        <g className="ss-drift ss-drift--5">
        ...
        <g className="ss-drift ss-drift--6">
