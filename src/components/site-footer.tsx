...
export function SiteFooter() {
  return (
    <footer className="w-full max-w-5xl rounded-2xl border border-border-soft bg-paper p-6 sm:p-10">
      <div className="grid grid-cols-2 gap-8 sm:grid-cols-4">
        ...
        {columns.map((col) => (
          <nav key={col.heading} aria-label={col.heading}>
            <p className="text-xs font-medium tracking-wide text-ink-soft uppercase">{col.heading}</p>
